...
const FEATURES = [
  {
    title: 'AI Summaries',
    description:
      'Get a concise, structured summary of any PDF in seconds. Powered by Gemini.',
    icon: (
  ...
  },
  {
    title: 'Flashcards',
    description:
      'Automatically generated flashcards from your document. Study smarter.',
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      'Test your knowledge with multiple-choice and open-ended questions generated from your content.',
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-gray-900 text-sm">AI Learning Assistant</span>
        </div>
        <button
      ...
      <section className="max-w-4xl mx-auto px-6 pt-20 pb-24 text-center">
        <div className="inline-flex items-center gap-2 bg-indigo-50 text-indigo-700 rounded-full px-3 py-1 text-xs font-medium mb-6">
        ...
        <h1 className="text-5xl font-bold text-gray-900 tracking-tight leading-tight mb-6">
          Turn any PDF into
          <br />
          <span className="text-indigo-600">active learning material</span>
        </h1>
        ...
        <button
          onClick={loginWithGoogle}
          className="inline-flex items-center gap-3 bg-gray-900 text-white text-sm font-medium px-6 py-3 rounded-xl hover:bg-gray-700 transition-colors shadow-sm"
        >
          {/* Google G icon */}
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {FEATURES.map((f) => (
              <div key={f.title} className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
                <div className="h-9 w-9 rounded-lg bg-indigo-50 text-indigo-600 flex items-center justify-center mb-4">
                  {f.icon}
                </div>
