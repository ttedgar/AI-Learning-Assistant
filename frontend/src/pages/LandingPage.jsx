  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-200 flex flex-col">
      ...
      <section className="flex-1 flex items-center justify-center px-6 py-12">
        ...
        <div className="inline-flex items-center gap-2 bg-violet-50 dark:bg-violet-950 text-violet-700 dark:text-violet-400 rounded-full px-3 py-1 text-xs font-medium mb-6">
          <span className="h-1.5 w-1.5 rounded-full bg-violet-600 dark:bg-violet-400" />
          ✦ Generated by a random free AI model
        </div>
