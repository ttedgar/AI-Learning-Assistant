        ...
        <div className="mt-8">
          ...
          <Entry date="2026-03-17 — Day 2" title="Implementation — Git Worktrees & Parallel Development">
            ...
            <ul className="list-none space-y-1.5 pl-0">
              ...
              <li className="flex gap-2"><span className="text-indigo-500 font-bold flex-shrink-0">→</span><span><strong className="text-gray-800 dark:text-gray-200">AI Service</strong> — FastAPI endpoints, LangChain prompt management, OpenRouter integration (free tier), map-reduce chunking for long documents, Langfuse tracing, internal API key middleware.</span></li>
