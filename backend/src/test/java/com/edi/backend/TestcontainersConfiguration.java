 ...
 *
 * <p><strong>Note on Testcontainers 2.x:</strong> {@link PostgreSQLContainer} and
 * {@link RabbitMQContainer} are self-typed in TC 2.x and no longer use generic type parameters.
 */
